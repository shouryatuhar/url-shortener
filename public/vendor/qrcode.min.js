/**
 * EasyQRCodeJS / QRCode.js standalone client-side generator
 */
(function(window) {
  ...
  QRCode.prototype.makeCode = function(text) {
    var oModel = new QRCodeModel(0, this._options.correctLevel || 0);
    oModel.addData(text);
    oModel.make();
    ...
    var nCount = oModel.getModuleCount();
    var nWidth = this._options.width / nCount;
    var nHeight = this._options.height / nCount;
